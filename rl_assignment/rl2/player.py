...
class PlayerControllerRL(PlayerController, FishesModelling):
    ...
    def q_learning(self):
        ...
        Q = np.random.uniform(low=0, high=1, size=(ns,na))
        # print(Q)
        # ADD YOUR CODE SNIPPET BETWEEN EX. 2.1
        ...
        while episode <= self.episode_max:
            ...
            while not end_episode:
                ...
                for i in list_pos:
                    # print(i)
                    if Q[s_current,i] > score:
                        score = max((Q[s_current,i]),score)
                        action = i
                # print(action)
                #print(action)
                # ADD YOUR CODE SNIPPET BETWEEN EX 2.1 and 2.2
                ...
                Q[s_current, action] += self.alpha * (R + self.gamma * np.nanmax(Q[s_next]) - Q[s_current, action])
                # print(Q)
                # ADD YOUR CODE SNIPPET BETWEEN EX. 2.2
